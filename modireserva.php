            ...
            <div class="reservation position-relative overlay-top overlay-bottom">
                <div class="row align-items-center">
                    <div class="col-lg-6 my-5 my-lg-0">
                        <div class="p-5">
                            <div class="mb-4">
                                ...
                                <h1 class="text-primary">Modifique su reserva</h1>
                            </div>
                            <?php
                            include("db.php");
                            include("validar.php");
                    ...
                    <form action="modireserva.php" method="post">
                      ...
                      <label class="text-primary text-uppercase mb-4 "for="gmail">gmail:</label><br>
                     ...
                     <input name="btnreserva" class="btn" type="submit" value="Guardar Cambios">
                    ...
                    <form action="estrureserva.php" method="post">
                     ...
                     input[name="btnregresarestru"] {
                      }
                      </style>
                     <input name="btnregresarestru" class="btn" type="submit" value="Regresar">
